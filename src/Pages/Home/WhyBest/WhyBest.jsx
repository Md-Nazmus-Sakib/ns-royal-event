    ...
    return (
        <div className='my-12'>
            <div className='sm:w-1/2 mx-auto text-center'>
                ...
                <h1 className='text-5xl font-bold my-8 mx-auto p-2 w-5/6 '>TO SAVE YOUR VALUABLE TIME WITH US</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-12 gap-12'>
                <div data-aos="fade-right" data-aos-offset="300" data-aos-duration="3000" className=' text-justify'>
                ...
                <div data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-delay='300' data-aos-duration="1500" className=' text-justify'>
                    <div className="avatar flex justify-center">
                        <div className="w-64 mx-auto rounded-full ring ring-secondary ring-offset-base-100 ring-offset-2">
                            <img src={ceremonyImg} />
                        </div>
